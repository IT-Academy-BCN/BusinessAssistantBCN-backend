...
public class LargeStablishmentsResponseDto {
    ...
    public LargeStablishmentsResponseDto() {
    }

    public LargeStablishmentsResponseDto(String name, String surnames, int idCountry, String workplace, Date registerDate, byte idGender, boolean specialExpedient, String documentTypeNumber, boolean registered, byte idProvince, short idCity) {
        this.name = name;
