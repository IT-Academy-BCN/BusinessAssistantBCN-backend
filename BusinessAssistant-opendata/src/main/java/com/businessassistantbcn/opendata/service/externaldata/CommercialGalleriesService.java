...
public class CommercialGalleriesService {
    ...
    public Mono<GenericResultDto<CommercialGalleriesResponseDto>> getPage(int offset, int limit) {

        return httpProxy.getRequestData(URI.create(config.getDs_commercialgalleries()), CommercialGalleriesDto[].class)
                .flatMap(dtos -> {
    ...
    private Mono<GenericResultDto<CommercialGalleriesResponseDto>> getResultDto(
            int offset, int limit, Predicate<CommercialGalleriesDto> dtoFilter) {
        return httpProxy.getRequestData(URI.create(config.getDs_commercialgalleries()), CommercialGalleriesDto[].class)
